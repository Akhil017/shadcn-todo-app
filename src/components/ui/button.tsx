  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        pop: "[--r:0.5rem] [--p:2px] [--c:hsl(var(--primary))] group relative flex  items-center justify-center rounded-[var(--r)] bg-[var(--c)] bg-gradient-to-b from-white/20 from-0% to-white/0 to-100% text-white shadow-[0px_0px_0px_2px_var(--c),0px_1px_2px_0px_rgba(13,13,18,0.40)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 transition-all duration-150 before:absolute before:left-0 before:top-0 before:h-full before:w-full before:rounded-[calc(var(--r))] before:bg-gradient-to-b before:from-white/20 before:from-15% before:to-white/0 before:to-100% after:absolute after:top-[--p] after:h-[calc(100%-4px)] after:w-[calc(100%-4px)] after:rounded-[calc(var(--r)-var(--p))] after:bg-[var(--c)] after:bg-gradient-to-b after:from-white/10 after:from-0% after:to-white/0 after:to-100%  inline-flex items-center justify-center whitespace-nowrap",
      },
      size: {
